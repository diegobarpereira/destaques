...
class Atleta(BaseModel):
    ...
    def __init__(self, atleta_id: int, apelido: str, pontos: float, scout: Dict[str, int], posicao_id: int,
                 jogos_num: int, media_num: int, entrou_em_campo: bool,
    ...
    def from_dict(cls, data: dict, clubes: Dict[int, Clube], atleta_id: Optional[int] = None,
                  is_capitao: Optional[bool] = None, default=None) -> 'Atleta':
...
class Destaques(BaseModel):
    ...
    def __init__(self, posicao: str, clube_nome: str, escalacoes: int, atleta: Dict[str, str], adv: str) -> None:
        # locale.setlocale(locale.LC_ALL, 'de_DE.utf-8')
        locale.setlocale(locale.LC_ALL, 'pt_BR.UTF-8')
        self.posicao = posicao
        self.clube_nome = clube_nome
        self.escalacoes = locale.format_string("%d", escalacoes, grouping=True)
    ...
    @classmethod
    def from_dict(cls, data: dict, adv=None) -> 'Destaques':
        return cls(data['posicao'], data['clube_nome'], data['escalacoes'], data['Atleta'], adv)
...
class Partida(BaseModel):
    ...
    def __init__(self, data: datetime, local: str, valida: bool, clube_casa: Clube, placar_casa: int,
                 ...
                 placar_visitante: int, fim_de_jogo: str, status_transmissao_tr: str) -> None:
        self.data = data
        self.local = local
        self.valida = valida
